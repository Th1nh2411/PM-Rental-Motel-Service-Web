...
<body class="booking_table banner_area d_flex align-items-center">
  ...
  <path
	...
	<div class=" p-3  box ml-3 mx-auto "
		...
		<form:form action="insert.htm" modelAttribute="hopdong">
			<div class=" col-md-9 mx-auto mb-4">
				<div class="form-group row">
					<label class=" col-sm-5 col-form-label">Chọn khách:</label>
					<div class="col-sm-3">

						<form:select class="custom-select mr-sm-2" path="khach.MAKHACH"
							items="${khachs }" itemValue="MAKHACH" itemLabel="MAKHACH" />
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					<label class=" col-sm-5 col-form-label">Tiền
						cọc :</label>
					<div class="col-sm-6">

						<form:input placeholder="Nhập tiền cọc" class="form-control"
							path="TIENCOC" required="required" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-6">
							...
							<form:textarea placeholder="Note" class="form-control"
							path="GHICHU" row="2"/>
					</div>
				</div>
