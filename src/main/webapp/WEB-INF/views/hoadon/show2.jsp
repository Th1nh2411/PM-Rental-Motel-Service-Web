...
<body class="booking_table banner_area d_flex align-items-center">
	...
	<div class="   box  " style="width: 1113px;">
		...
		<c:url value="/hoadon/show2.htm" var="pagedLink">
			<c:param name="p" value="~" />
		</c:url>
		<!-- Main component for a primary marketing message or call to action -->
		<a class="btn btn-primary" href="insert.htm" role="button">Thêm
			hoá đơn</a> <a class="btn btn-danger"
			href="/QuanLyNhaTro/hoadon/show.htm" role="button">Hoá đơn chưa
			thanh toán</a>
			...
			<tbody>
				<c:forEach var="u" items="${pagedListHolder.pageList}">
					<tr>
						...
						<td><a href="hoadon/delete/${u.MAHOADON}.htm"
							onclick="return confirm('Bạn có muốn xoá hoá đơn này?');"> <i
