...
<body class="booking_table banner_area d_flex align-items-center">
  ...
  <path
	...
	<div class=" p-3  box ml-3 mx-auto " style="width: 600px;height: 720px">
		...
		<div class="qlpt-head form-group mt-4 mb-4">THÊM KHÁCH</div>
		<c:choose>
		...
		<form:form action="insert.htm" modelAttribute="khach">
			...
			<div class=" col-md-9 mx-auto mb-4">
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						<form:input placeholder="Nhập họ và tên" class="form-control" path="HOVATEN"
							required="required" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						<form:input placeholder="Nhập Email" class="form-control" path="EMAIL" required="required" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						<form:input placeholder="Nhập số CMND" class="form-control" path="SOCMND" required="required" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						<form:input placeholder="Nhập ngày sinh" class="form-control" path="NGAYSINH"
							required="required" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						<form:input placeholder="Nhập địa chỉ" class="form-control" path="DIACHI"
							required="required" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						<form:input placeholder="Nhập số điện thoại" class="form-control" path="SDT"
							required="required" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						<form:input placeholder="Nhập nghề nhiệp" class="form-control" path="NGHENGHIEP"
							required="required" />
					</div>
				</div>
			</div>
