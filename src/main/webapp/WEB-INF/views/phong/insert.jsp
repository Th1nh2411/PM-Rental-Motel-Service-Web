...
<body class="booking_table banner_area d_flex align-items-center">
  ...
  <path
	...
	<div class=" p-3  box ml-3 mx-auto "
		...
		<div class="qlpt-head form-group mt-4 mb-4">THÊM PHÒNG</div>
		<c:choose>
			<c:when test="${check==null}">

			</c:when>
			<c:otherwise>
				<div class="alert alert-success border-0 mx-auto col-md-6 " role="alert">
		...
		<div>
			...
			<form:form action="insert.htm" modelAttribute="phong">
				<div class= "col-md-5 mx-auto mb-4">
					<label>Chọn loại phòng</label>
					<form:select class="form-select "
						path="loaiphong.MALOAIPHONG" items="${loaiphongs }"
						itemValue="MALOAIPHONG" itemLabel="TENLOAIPHONG" />
				</div>
